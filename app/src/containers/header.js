...
function HeaderContainer(props){
    ...
    const conditionalSignin = user === null ? (<Header.Link to = {ROUTES.SIGN_IN}>Sign in</Header.Link>):
        ...
        const conditionallogo = user!==null ? <Header.ConditionLogoText to = {ROUTES.HOME}>PropertyPro</Header.ConditionLogoText>:<Header.Logo to = {ROUTES.HOME}>PropertyPro</Header.Logo>
