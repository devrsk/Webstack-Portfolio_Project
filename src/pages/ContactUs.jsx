...
export default function Contact() {
    ...
    useEffect(() => {
        window.scrollTo(0, 0);
        document.title = "Contact Us | Property Rent or Buy | PropertyPro";
    }, []);

    const contactMethods = {
        contact: "devrsk@tuta.io",
        phone: "+233 (024) 123-456",
                    ...
                    <div className="-mx-4 flex flex-wrap lg:justify-between">
                        <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                            <div className="mb-12 max-w-[570px] lg:mb-0">
                                <h2 className="text-dark mb-6 text-[28px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                                ...
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-body-color text-base">{contactMethods.contact}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
