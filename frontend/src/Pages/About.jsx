...
const About = () => {
    ...
    useEffect(() => {
        window.scrollTo(0, 0);
        document.title = "Who We Are | PropertyPro";
    }, []);
                    ...
                    <div className="grid gap-12">
                        ...
                        <div>
                            ...
                            <p className="text-gray-800">
                                Incorporated in 2023 by our founder and CEO, PropertyPro aims to revolutionize the real estate industry through cutting-edge technology, offering an efficient and seamless platform for buyers, sellers, and renters to transact with confidence, convenience, and peace of mind.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-gray-800">
                                At PropertyPro, we are on a mission to simplify the real estate process and minimize your stress levels. Our unwavering commitment to delivering top-notch customer service ensures that you receive unparalleled support at every stage of your real estate journey. Whether you&apos;re in the market to buy, sell, or rent property, we&apos;re dedicated to assisting you in finding your dream home, selling your current property, or managing your rental investments.
                            </p>
                            <br />
                            <p>
                        ...
                        <div>
                            ...
                            <p className="text-gray-800">
                                With so many real estate companies out there, why should you choose PropertyPro? Here are just a few reasons:
                            </p>
                            <br />
                            <div className="flex flex-col gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-800">
                                        At PropertyPro, we believe that technology should make your life easier. That&apos;s why we&apos;ve invested in cutting-edge tools and software to streamline the real estate process and provide you with a seamless, hassle-free experience.
                                    </p>
                                </div>
                                <div>
                                    <h3 className="text-2xl font-semibold text-gray-800 mb-2">
                        ...
                        <div>
                            ...
                            <p className="text-gray-800">
                                Ready to get started? Contact us today to learn more about our services and how we can help you achieve your real estate goals. Whether you&apos;re looking to buy, sell, or rent property, we&apos;re here to help you every step of the way. Thank you for choosing PropertyPro!
                            </p>
                        </div>
