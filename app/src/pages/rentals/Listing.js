...
function Listing() {
    ...
    async function handleDelete(id) {
        try {
            ...
            if (result.success) {
                ...
                setListing((prevListing) => prevListing.filter(item => item.R_ID !== id));
            } else {
    ...
    function ListingCard({ obj, keyProp }) {
        ...
        return (
            <ListingForm.Base key={keyProp}>
                ...
                <ListingForm.Button to={ROUTES.LISTING} func={handleDelete} id={obj.R_ID}>
                    Remove
                </ListingForm.Button>
            </ListingForm.Base>
        );
    ...
    if (Listing && Listing.length) {
        ...
        console.log("My key is this " + Listing[0].R_ID);
